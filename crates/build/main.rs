...
fn main() {
	...
	cmd!(
		...
		"--release",
		"--target",
		Target::AArch64LinuxGnu228.rust_target(),
		// "--target",
		// Target::AArch64LinuxMusl.rust_target(),
		//"--target",
		//Target::AArch64MacOS.rust_target(),
		"--target",
		Target::X8664LinuxGnu228.rust_target(),
		// "--target",
		// Target::X8664LinuxMusl.rust_target(),
		//"--target",
		//Target::X8664MacOS.rust_target(),
		"--target",
		Target::X8664WindowsGnu.rust_target(),
		"--target",
		Target::X8664WindowsMsvc.rust_target(),
		"--package",
		"tangram_cli",
		"--package",
		"libtangram",
