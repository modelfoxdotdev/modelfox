 ...
 * @ignore
 */
export declare function setNative(newNative: any): void;
/**
 ...
 */
export declare type LoadModelOptions = {
    /**
 ...
 */
export declare type PredictInput = {
 ...
 */
export declare type PredictOutput<TaskType extends Task> = {
 ...
 */
export declare type RegressionPredictOutput = {
 ...
 */
export declare type BinaryClassificationPredictOutput<Classes = string> = {
 ...
 */
export declare type MulticlassClassificationPredictOutput<Classes = string> = {
    ...
    featureContributions?: {
        [K in keyof Classes]: FeatureContributions;
    };
};
/**
 ...
 */
export declare type FeatureContributions = {
    /**
...
export declare type FeatureContributionEntry = IdentityFeatureContribution | NormalizedFeatureContribution | OneHotEncodedFeatureContribution | BagOfWordsFeatureContribution | BagOfWordsCosineSimilarityFeatureContribution | WordEmbeddingFeatureContribution;
/**
 * This identifies the type of a feature contribution.
 */
export declare enum FeatureContributionType {
    Identity = "identity",
 ...
 */
export declare type IdentityFeatureContribution = {
 ...
 */
export declare type NormalizedFeatureContribution = {
 ...
 */
export declare type OneHotEncodedFeatureContribution = {
 ...
 */
export declare type BagOfWordsFeatureContribution = {
 ...
 */
export declare type NGram = string | [string, string];
/**
 * This describes the contribution of a feature from a bag of words feature group.
 */
export declare type BagOfWordsCosineSimilarityFeatureContribution = {
 ...
 */
export declare type WordEmbeddingFeatureContribution = {
 ...
 */
export declare type LogPredictionArgs<TaskType extends Task, InputType extends PredictInput> = {
    /**
 ...
 */
export declare type LogTrueValueArgs = {
    /**
 ...
 */
export declare class Model<TaskType extends Task, InputType extends PredictInput, OutputType extends PredictOutput<TaskType>> {
    private model;
    private tangramUrl;
    private logQueue;
    /**
     ...
     */
    predict<PredictInput extends InputType | InputType[]>(input: PredictInput, options?: PredictOptions): PredictInput extends InputType[] ? OutputType[] : OutputType;
    /**
     ...
     */
    logPrediction(args: LogPredictionArgs<TaskType, InputType>): Promise<void>;
    /**
